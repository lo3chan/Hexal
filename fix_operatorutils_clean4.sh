...
import at.petrak.hexcasting.api.casting.iota.GateIota
...
fun Int.addBounded(int: Int): Int {
    ...
    val limit = Int.MIN_VALUE xor (sum ushr 31)
    val overflow: Int = ((this xor sum) and (this xor int).inv()) ushr 31
...
fun Int.mulBounded(int: Int): Int {
    val result: Long = this.toLong() * int.toLong()
